...
class GetUpdateDeleteStudent(Resource):
    ...
    @student_namespace.doc(
        description="""
            Only admins Update of a particular student
        """
    )
    @admin_or_lecturer_required()
...
class GetStudentCourses(Resource):
    ...
    @student_namespace.doc(
        description="""
            Only admins and lecturers retrieve a particular student courses
        """
    )
    @admin_or_lecturer_required()
    def get(self, student_id):
...
class UpdateStudentCourseScore(Resource):
    ...
    @student_namespace.doc(
        description="""
            Only course lecturer can update of a particular student score in a course
        """
    )
    @lecturer_required()
...
class GetStudentGPA(Resource):
    ...
    @student_namespace.doc(
        description="""
            Only admins and lecturers can calculate a particular student course GPA
        """
    )
    @admin_or_lecturer_required()
...
class GetStudentCoursesGrades(Resource):
    ...
    @student_namespace.doc(
        description="""
            Only admins and lecturers can retrieve a particular student courses and grades
        """
    )
    @admin_or_lecturer_required()
    def get(self, student_id):
